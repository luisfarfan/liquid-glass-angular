 ...
 */
export interface GngSidebarItemModel {
  getIndicatorAnchor(): HTMLElement | null;
  isActive: boolean;
}

@Injectable()
export class GngSidebarService {
   ...
   */
  readonly activeItem = signal<GngSidebarItemModel | null>(null);
   ...
   */
  setActiveItem(item: GngSidebarItemModel | null) {
