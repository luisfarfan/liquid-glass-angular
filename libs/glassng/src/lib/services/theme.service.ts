...
export class GngThemeService {
  private readonly config = inject(GNG_THEME_CONFIG);
  ...
  private applyTheme(theme: LGThemeDefinition) {
     ...
     */
    html.classList.add('gng-no-transitions');
    ...
    requestAnimationFrame(() => {
      html.classList.remove('gng-no-transitions');
    });
  }
}
