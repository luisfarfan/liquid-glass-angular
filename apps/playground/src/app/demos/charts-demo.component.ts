...
import { GngKpiCard, GngTimeline, GngTimelineItem } from 'glassng';

@Component({
  selector: 'app-charts-demo',
  standalone: true,
  imports: [CommonModule, GngKpiCard, GngTimeline, GngTimelineItem],
  template: `
    <div class="space-y-12">
      <div>
        <h1 class="text-3xl font-bold tracking-tight text-[var(--gng-t-text-main)]">Stats & Metrics</h1>
        <p class="text-[var(--gng-t-text-muted)] mt-2">Diferentes variantes del <code>gng-kpi-card</code> inspiradas en PrimeBlocks y Tailkit.</p>
      </div>
